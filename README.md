![](https://img.shields.io/github/commit-activity/t/subhamay-bhattacharyya/9995-sam-template)&nbsp;![](https://img.shields.io/github/last-commit/subhamay-bhattacharyya/9995-sam-template)&nbsp;![](https://img.shields.io/github/release-date/subhamay-bhattacharyya/9995-sam-template)&nbsp;![](https://img.shields.io/github/repo-size/subhamay-bhattacharyya/9995-sam-template)&nbsp;![](https://img.shields.io/github/directory-file-count/subhamay-bhattacharyya/9995-sam-template)&nbsp;![](https://img.shields.io/github/actions/workflow/status/subhamay-bhattacharyya/9995-sam-template/deploy-stack.yaml)&nbsp;![](https://img.shields.io/github/issues/subhamay-bhattacharyya/9995-sam-template)&nbsp;![](https://img.shields.io/github/languages/top/subhamay-bhattacharyya/9995-sam-template)&nbsp;![](https://img.shields.io/github/commit-activity/m/subhamay-bhattacharyya/9995-sam-template)&nbsp;![](https://img.shields.io/endpoint?url=https://gist.githubusercontent.com/bsubhamay/b21a193b71079cfd71034ff303e7cae9/raw/9995-sam-template.json?)
...
```
{
    ...
    "Statement": [
        ...
        },
        {
            ...
            "Resource": [
                "arn:aws:kms:<AWS Region>:<AWS Account Id>:key/<Cust Managed KMS Key Id>",
                "arn:aws:kms:<AWS Region>:<AWS Account Id>:key/<AWS S3 KMS Key>"
            ]
        },
        {
...
|DEVL_AWS_CLOUDFORMATION_ROLE_ARN|```arn:aws:iam::<Development Account Id>:role/<OIDC IAM Role Name>```|
|TEST_AWS_CLOUDFORMATION_ROLE_ARN|```arn:aws:iam::<Test Account Id>:role/<OIDC IAM Role Name>```|
|TEST_AWS_CLOUDFORMATION_ROLE_ARN|```arn:aws:iam::<Production Account Id>:role/<OIDC IAM Role Name>```|
|DEVL_AWS_SAM_PIPELINE_ROLE_ARN|```arn:aws:iam::<Development Account Id>:role/<OIDC IAM Role Name>```|
|TEST_AWS_SAM_PIPELINE_ROLE_ARN|```arn:aws:iam::<Test Account Id>:role/<OIDC IAM Role Name>```|
|PROD_AWS_SAM_PIPELINE_ROLE_ARN|```arn:aws:iam::<Production Account Id>:role/<OIDC IAM Role Name>```|
|DEVL_AWS_SAM_ARTIFACTS_BUCKET_NAME|```<SAM Artifacts S3 Bucket in Development>```|
|TEST_AWS_SAM_ARTIFACTS_BUCKET_NAME|```<SAM Artifacts S3 Bucket in Test>```|
|PROD_AWS_SAM_ARTIFACTS_BUCKET_NAME|```<SAM Artifacts  S3 Bucket in Production>```|
